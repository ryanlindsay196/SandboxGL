...
Light* LightManager::AddLight(std::vector<std::string>& lightProperties, unsigned int newEntityComponentIndex, Entity* parentEntity)
{
	AddComponent<Light>(m_lights, newEntityComponentIndex, parentEntity);
