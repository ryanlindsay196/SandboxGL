...
void ObjectManager::Initialize(GLFWwindow* window)
{
	...
	modelManager->LoadModel(glm::vec3(0, 0, 0), glm::vec3(0, 0, 1), 0.0f, glm::vec3(1.f, 1.f, 1.f));
	entityManager->InstantiateEntity(EntityManager::EntityProperties(), glm::vec3(0, 0, 1), glm::vec3(1, 0, 0), 0.0f, glm::vec3(1, 1, 1), nullptr);
...
void ObjectManager::Update(float gameTime)
{
	...
	//cameraManager->GetCamera(0)->Translate(glm::vec3(0, 0, -0.0011f));
